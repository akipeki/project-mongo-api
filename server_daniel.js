...
//     const propertyNames = Object.getOwnPropertyNames(args[i]);
//     propertyNames.map(singleKey => {
//       if (result.hasOwnProperty(singleKey)) {
//          result[singleKey] = result[singleKey] + args[i][singleKey] 
//       } else {
//          result[singleKey] = args[i][singleKey] 
//       }
//     });
//   }
//   return result;
